...
def test_typing_indicator_init_edge_case_non_empty_dict():
    indicator = TypingIndicator()
    indicator.typing_users = {"room1": {"user1": {"username": "Alice", "started_at": None}}}
    assert indicator.typing_users == {"room1": {"user1": {"username": "Alice", "started_at": None}}}
