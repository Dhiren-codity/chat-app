...
@pytest.mark.parametrize("initial_data, room_id, user_id, expected_data", [
    ...
    ({}, "room1", "user1", {}),
    # Edge case: user stops typing in a different room
    ({"room1": {"user1": {"username": "Alice", "started_at": None}}, "room2": {"user2": {"username": "Bob", "started_at": None}}}, "room1", "user2", {"room1": {"user1": {"username": "Alice", "started_at": None}}, "room2": {"user2": {"username": "Bob", "started_at": None}}}),
])
