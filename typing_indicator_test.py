...
def test_user_started_typing_overwrite_user(typing_indicator, room_id, user_id, username):
...
@pytest.mark.parametrize("room_id, user_id, expected", [
    ...
    ('room1', 'user2', {'room1': {'user1': True}, 'room2': {'user3': True}})  # Remove another user
])
