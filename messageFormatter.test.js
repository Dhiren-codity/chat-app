...
describe('MessageFormatter', () => {
  ...
  describe('MessageFormatter', () => {
    ...
    describe('methodToTest', () => {
      ...
      it('should return "Just now" for time within a few seconds ago', () => {
        const now = new Date();
      ...
      it('should return "Just now" for time within a minute ago', () => {
        const now = new Date();
      ...
      it('should not return "Just now" for time more than a minute ago', () => {
        const now = new Date();
        const moreThanAMinuteAgo = new Date(now.getTime() - 61000);
  ...
  describe('MessageFormatter', () => {
    ...
    describe('truncateMessage', () => {
      ...
      it('should handle maxLength less than or equal to 3 correctly', () => {
        const message = 'Hello';
        const result = messageFormatter.truncateMessage(message, 3);
        expect(result).toBe('...');
      });
  ...
  describe('MessageFormatter', () => {
    describe('sanitizeMessage', () => {
      ...
      it('should escape multiple special characters', () => {
        expect(MessageFormatter.sanitizeMessage('Hello & < > " \'' )).toBe('Hello &amp; &lt; &gt; &quot; &#x27;');
      });
