...
describe('MessageFormatter', () => {
  ...
  describe('MessageFormatter', () => {
    ...
    describe('method to test', () => {
      ...
      it('should return "Just now" for a time within a few seconds ago', () => {
        const now = new Date();
      ...
      it('should return "Just now" for a time within a minute ago', () => {
        const now = new Date();
  ...
  describe('MessageFormatter', () => {
    ...
    describe('extractUrls', () => {
      ...
      it('should handle URLs with query parameters and fragments', () => {
        const result = messageFormatter.extractUrls('Check this: https://example.com/path?query=123#fragment');
        expect(result).toEqual(['https://example.com/path?query=123#fragment']);
      });
    });
  });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('linkifyUrls', () => {
      ...
      it('should handle a mix of text and URLs', () => {
        const message = 'Text before http://example.com and text after.';
        const expected = 'Text before <a href="http://example.com" target="_blank" rel="noopener noreferrer">http://example.com</a> and text after.';
        expect(formatter.linkifyUrls(message)).toBe(expected);
      });
    });
  });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('Method to test', () => {
      ...
      it('should process a valid messageData object correctly', () => {
        const messageData = {
      ...
      it('should handle messageData without sender', () => {
        const messageData = {
          content: 'Hello world!',
          timestamp: 1633072800000
        };
  ...
  describe('MessageFormatter', () => {
    ...
    describe('methodToTest', () => {
      it('should return 0 for a typical input', () => {
        const result = messageFormatter.methodToTest('some input');
