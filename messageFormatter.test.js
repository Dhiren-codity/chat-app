  ...
  describe('MessageFormatter', () => {
    ...
    describe('linkifyUrls', () => {
      ...
      it('should handle URLs with special characters', () => {
        const message = 'Visit https://example.com/path/to/resource?query=param&another=param';
        const expected = 'Visit <a href="https://example.com/path/to/resource?query=param&another=param" target="_blank" rel="noopener noreferrer">https://example.com/path/to/resource?query=param&another=param</a>';
        expect(formatter.linkifyUrls(message)).toBe(expected);
      });
  
      it('should not modify URLs that are already hyperlinks', () => {
        const message = 'Already linked: <a href="http://example.com" target="_blank" rel="noopener noreferrer">http://example.com</a>';
        expect(formatter.linkifyUrls(message)).toBe(message);
      });
    });
  });
