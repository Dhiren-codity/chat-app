...
describe('MessageFormatter', () => {
  ...
  describe('MessageFormatter', () => {
    ...
    describe('formatMinutesAgo', () => {
      it('should return "1 minute ago" when diffMins is 1', () => {
        const result = messageFormatter.formatMinutesAgo(1);
        expect(result).toBe('1 minute ago');
      });
  
      it('should return "2 minutes ago" when diffMins is 2', () => {
        const result = messageFormatter.formatMinutesAgo(2);
        expect(result).toBe('2 minutes ago');
      });
  
      it('should return "0 minutes ago" when diffMins is 0', () => {
        const result = messageFormatter.formatMinutesAgo(0);
        expect(result).toBe('0 minutes ago');
      });
  
      it('should return "100 minutes ago" when diffMins is 100', () => {
        const result = messageFormatter.formatMinutesAgo(100);
        expect(result).toBe('100 minutes ago');
      });
  
      it('should handle negative numbers gracefully', () => {
        const result = messageFormatter.formatMinutesAgo(-5);
  ...
  describe('MessageFormatter', () => {
    ...
    describe('extractMentions', () => {
      ...
      it('should return an array with mentions when message has special characters', () => {
        const result = messageFormatter.extractMentions('Hello @user! How are you? @another_user');
        expect(result).toEqual(['user', 'another_user']);
      });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('extractUrls', () => {
      ...
      it('should return an empty array when message is not a string', () => {
        const result = messageFormatter.extractUrls(123);
        expect(result).toEqual([]);
      });
      ...
      it('should return an empty array when there are no URLs in the message', () => {
        const result = messageFormatter.extractUrls('This is a test message without URLs.');
        expect(result).toEqual([]);
      });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('methodToTest', () => {
      ...
      it('should return formatted message object for valid input', () => {
        ...
        jest.spyOn(messageFormatter, 'highlightMentions').mockReturnValue('Hello <b>@user</b>, check this out: <a href="http://example.com">http://example.com</a>');
        ...
        expect(result).toEqual({
          content: 'Hello <b>@user</b>, check this out: <a href="http://example.com">http://example.com</a>',
  ...
  describe('MessageFormatter', () => {
    ...
    describe('formatMessage', () => {
      ...
      it('should handle null input gracefully', () => {
        const input = null;
        expect(() => messageFormatter.formatMessage(input)).toThrow('Invalid input');
      });
