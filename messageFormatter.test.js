...
describe('MessageFormatter', () => {
  ...
  describe('MessageFormatter', () => {
    ...
    describe('formatTimeAgo', () => {
      ...
      it('should return "60 minutes ago" for 60 minutes', () => {
        const result = messageFormatter.formatTimeAgo(60);
  ...
  describe('MessageFormatter', () => {
    ...
    describe('truncateMessage', () => {
      it('should return an empty string if message is null or undefined', () => {
      ...
      it('should return the original message if its length is less than or equal to maxLength', () => {
        ...
        expect(formatter.truncateMessage('Hello', 5)).toBe('Hello');
      });
  
      it('should truncate the message and append "..." if its length is greater than maxLength', () => {
        expect(formatter.truncateMessage('Hello, World!', 10)).toBe('Hello, W...');
        expect(formatter.truncateMessage('This is a test message', 14)).toBe('This is a t...');
      });
  
      it('should handle edge case where maxLength is less than or equal to 3', () => {
        expect(formatter.truncateMessage('Hello', 3)).toBe('...');
        expect(formatter.truncateMessage('Hello', 2)).toBe('...');
        expect(formatter.truncateMessage('Hello', 1)).toBe('...');
        expect(formatter.truncateMessage('Hello', 0)).toBe('');
      });
  
      it('should handle edge case where message is an empty string', () => {
        expect(formatter.truncateMessage('', 10)).toBe('');
      });
    });
  });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('extractUrls', () => {
      ...
      it('should return an empty array when URLs are malformed', () => {
        const result = messageFormatter.extractUrls('Malformed URL: htt://example.com');
        expect(result).toEqual([]);
      });
  
      it('should not match URLs with spaces', () => {
        const result = messageFormatter.extractUrls('Invalid URL: https:// example .com');
        expect(result).toEqual([]);
      });
    });
  });
