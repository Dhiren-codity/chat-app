...
describe('MessageFormatter', () => {
  ...
  describe('MessageFormatter', () => {
    ...
    describe('method to test', () => {
      ...
      it('should return "Just now" for a time within the last minute', () => {
        const now = new Date();
        const lessThanAMinuteAgo = new Date(now.getTime() - 30 * 1000); // 30 seconds ago
        const result = messageFormatter.methodToTest(lessThanAMinuteAgo);
        expect(result).toBe('Just now');
      });
  
      it('should not return "Just now" for a time more than a minute ago', () => {
        const now = new Date();
        const moreThanAMinuteAgo = new Date(now.getTime() - 61 * 1000); // 61 seconds ago
      ...
      it('should handle edge case of exactly one minute ago', () => {
        const now = new Date();
        const exactlyOneMinuteAgo = new Date(now.getTime() - 60 * 1000); // 60 seconds ago
        const result = messageFormatter.methodToTest(exactlyOneMinuteAgo);
        expect(result).not.toBe('Just now');
      });
  
      it('should handle future dates gracefully', () => {
        const now = new Date();
        const futureDate = new Date(now.getTime() + 60 * 1000); // 60 seconds in the future
        const result = messageFormatter.methodToTest(futureDate);
        expect(result).not.toBe('Just now');
      });
    });
  });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('formatTimeAgo', () => {
      ...
      it('should return "100 minutes ago" when diffMins is 100', () => {
        const result = messageFormatter.formatTimeAgo(100);
        expect(result).toBe('100 minutes ago');
      });
  
      it('should handle negative numbers gracefully', () => {
        const result = messageFormatter.formatTimeAgo(-5);
  ...
  describe('MessageFormatter', () => {
    ...
    describe('truncateMessage', () => {
      ...
      it('should truncate the message and add ellipsis if its length is greater than maxLength', () => {
        const message = 'HelloWorld!';
        const result = messageFormatter.truncateMessage(message, 10);
        expect(result).toBe('HelloW...');
      });
  
      it('should handle maxLength less than 3 by returning ellipsis only', () => {
        const message = 'HelloWorld!';
        const result = messageFormatter.truncateMessage(message, 2);
        expect(result).toBe('...');
      });
  
      it('should handle maxLength of 0 by returning an empty string', () => {
        const message = 'HelloWorld!';
  ...
  describe('MessageFormatter', () => {
    ...
    describe('extractMentions', () => {
      ...
      it('should handle mentions with numbers and underscores', () => {
        const result = messageFormatter.extractMentions('Hello @user_123 and @another_user');
        expect(result).toEqual(['user_123', 'another_user']);
      });
      ...
      it('should not return duplicates for repeated mentions', () => {
        const result = messageFormatter.extractMentions('Hello @user @user');
  ...
  describe('MessageFormatter', () => {
    ...
    describe('highlightMentions', () => {
      ...
      it('should not highlight mentions with special characters', () => {
        ...
        const expected = 'Hello @user-name!';
        expect(formatter.highlightMentions(message)).toBe(expected);
      });
    });
  });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('extractUrls', () => {
      ...
      it('should return an empty array when URLs are malformed', () => {
        const result = messageFormatter.extractUrls('Malformed URLs: htt://example, https//example.com');
        expect(result).toEqual([]);
      });
    });
  });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('linkifyUrls', () => {
      ...
      it('should handle URLs with query parameters', () => {
        const message = 'Search on https://example.com?q=test';
        const expected = 'Search on <a href="https://example.com?q=test" target="_blank" rel="noopener noreferrer">https://example.com?q=test</a>';
        expect(formatter.linkifyUrls(message)).toBe(expected);
      });
  
      it('should handle URLs with special characters', () => {
        const message = 'Check this: https://example.com/path?arg=value&another=one';
        const expected = 'Check this: <a href="https://example.com/path?arg=value&another=one" target="_blank" rel="noopener noreferrer">https://example.com/path?arg=value&another=one</a>';
        expect(formatter.linkifyUrls(message)).toBe(expected);
      });
  
      it('should not modify already linkified URLs', () => {
        const message = 'Already linkified: <a href="http://example.com" target="_blank" rel="noopener noreferrer">http://example.com</a>';
        expect(formatter.linkifyUrls(message)).toBe(message);
      });
    });
  });
  ...
  describe('MessageFormatter', () => {
    describe('sanitizeMessage', () => {
      ...
      it('should handle a string with multiple special characters', () => {
        ...
        expect(MessageFormatter.sanitizeMessage(input)).toBe(expected);
      });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('Method to test', () => {
      ...
      it('should handle message with multiple mentions and URLs', () => {
        const messageData = {
          content: '@user1 and @user2, visit http://example1.com and http://example2.com',
          timestamp: 1633072800000,
          sender: 'Alice'
        };
        const result = messageFormatter.methodToTest(messageData);
        expect(result).toEqual({
          content: expect.any(String),
          originalContent: '@user1 and @user2, visit http://example1.com and http://example2.com',
          timestamp: expect.any(String),
          sender: 'Alice',
  ...
  describe('MessageFormatter', () => {
    ...
    describe('countWords', () => {
      ...
      it('should handle a mix of spaces, tabs, and newlines correctly', () => {
        expect(messageFormatter.countWords('hello \t\n world')).toBe(2);
      });
    });
  });
