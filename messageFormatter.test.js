...
describe('MessageFormatter', () => {
  ...
  describe('MessageFormatter', () => {
    ...
    describe('formatTimeAgo', () => {
      ...
      it('should return "100 minutes ago" for diffMins = 100', () => {
  ...
  describe('MessageFormatter', () => {
    ...
    describe('methodToTest', () => {
      ...
      it('should return the same message for a string with newline characters', () => {
        const message = 'Hello\nWorld';
        const result = messageFormatter.methodToTest(message);
        expect(result).toBe(message);
      });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('linkifyUrls', () => {
      ...
      it('should not modify URLs within HTML tags', () => {
        const message = '<a href="http://example.com">Link</a>';
        expect(formatter.linkifyUrls(message)).toBe(message);
      });
    });
  });
