...
describe('MessageFormatter', () => {
  ...
  describe('MessageFormatter', () => {
    ...
    describe('formatTimestamp', () => {
      it('should return an empty string if timestamp is null or undefined', () => {
      ...
      it('should return "x minutes ago" for timestamps less than an hour ago', () => {
        const now = new Date();
        const timestamp = new Date(now.getTime() - 1800000).toISOString(); // 30 minutes ago
        expect(messageFormatter.formatTimestamp(timestamp)).toBe('30 minutes ago');
      });
      ...
      it('should return "x hours ago" for timestamps less than a day ago', () => {
        const now = new Date();
        const timestamp = new Date(now.getTime() - 7200000).toISOString(); // 2 hours ago
        expect(messageFormatter.formatTimestamp(timestamp)).toBe('2 hours ago');
      });
      ...
      it('should return "x days ago" for timestamps less than a week ago', () => {
        const now = new Date();
      ...
      it('should return the date string for timestamps older than a week', () => {
        const now = new Date();
  ...
  describe('MessageFormatter', () => {
    ...
    describe('highlightMentions', () => {
      ...
      it('should not highlight invalid mentions', () => {
        const message = 'Hello @!';
        expect(formatter.highlightMentions(message)).toBe('Hello @!');
      });
  
      it('should handle consecutive mentions', () => {
        const message = '@user1@user2';
        const expected = '<span class="mention">@user1</span><span class="mention">@user2</span>';
        expect(formatter.highlightMentions(message)).toBe(expected);
      });
    });
  });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('extractUrls', () => {
      ...
      it('should return an empty array when URLs are malformed', () => {
        const result = messageFormatter.extractUrls('Malformed URLs: htt://example.com, https//example.com');
        expect(result).toEqual([]);
      });
    });
  });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('Method to test', () => {
      ...
      it('should handle missing sender by returning "Unknown"', () => {
        const messageData = {
          content: 'Hello world!',
          timestamp: 1633072800000
        };
