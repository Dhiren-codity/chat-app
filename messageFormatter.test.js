...
describe('MessageFormatter', () => {
  ...
  describe('MessageFormatter', () => {
    ...
    describe('methodToTest', () => {
      ...
      it('should return the same message for a string with mixed content', () => {
  ...
  describe('MessageFormatter', () => {
    ...
    describe('methodToTest', () => {
      ...
      it('should return an empty string for a string with special characters', () => {
        const result = messageFormatter.methodToTest('!@#$%^&*()');
        expect(result).toBe('');
      });
  
      it('should return an empty string for a string with spaces', () => {
        const result = messageFormatter.methodToTest('   ');
        expect(result).toBe('');
      });
    });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('Method to test', () => {
      ...
      it('should format message data correctly with valid input', () => {
        const messageData = {
      ...
      it('should extract multiple mentions and URLs', () => {
        const messageData = {
          content: '@user1 @user2 check this: http://example.com http://test.com',
          timestamp: 1633072800000,
          sender: 'John Doe'
        };
