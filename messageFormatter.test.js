...
describe('MessageFormatter', () => {
  ...
  describe('MessageFormatter', () => {
    ...
    describe('truncateMessage', () => {
      ...
      it('should handle edge case where maxLength is negative', () => {
        const message = 'HelloWorld!';
        const result = messageFormatter.truncateMessage(message, -5);
        expect(result).toBe('');
      });
    });
  });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('highlightMentions', () => {
      ...
      it('should not highlight mentions with special characters', () => {
        ...
        expect(formatter.highlightMentions(message)).toBe('Hello @user-name!');
      });
    });
  });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('linkifyUrls', () => {
      ...
      it('should handle URLs with special characters', () => {
        const message = 'Visit https://example.com/path/to/resource?query=param&another=value';
        const expected = 'Visit <a href="https://example.com/path/to/resource?query=param&another=value" target="_blank" rel="noopener noreferrer">https://example.com/path/to/resource?query=param&another=value</a>';
        expect(formatter.linkifyUrls(message)).toBe(expected);
      });
