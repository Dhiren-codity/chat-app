...
describe('MessageFormatter', () => {
  ...
  describe('MessageFormatter', () => {
    ...
    describe('truncateMessage', () => {
      ...
      it('should return the original message if its length is less than or equal to maxLength', () => {
        expect(formatter.truncateMessage('Hello', 10)).toBe('Hello');
      });
  
      it('should return the original message if its length is exactly maxLength', () => {
  ...
  describe('MessageFormatter', () => {
    ...
    describe('linkifyUrls', () => {
      it('should return an empty string if message is null', () => {
        const result = messageFormatter.linkifyUrls(null);
        expect(result).toBe('');
      });
  
      it('should return an empty string if message is undefined', () => {
        const result = messageFormatter.linkifyUrls(undefined);
        expect(result).toBe('');
      });
  
      it('should return an empty string if message is not a string', () => {
        const result = messageFormatter.linkifyUrls(123);
        expect(result).toBe('');
      });
  
      it('should return the same string if there are no URLs', () => {
        const message = 'This is a test message without URLs.';
        const result = messageFormatter.linkifyUrls(message);
        expect(result).toBe(message);
      });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('Method to test', () => {
      ...
      it('should sanitize, linkify, and highlight mentions correctly', () => {
        const messageData = {
      ...
      it('should extract mentions and urls correctly', () => {
        const messageData = {
          content: 'Hello @user1 and @user2, visit http://example.com and https://another.com',
          timestamp: 1633072800000,
          sender: 'Alice'
        };
