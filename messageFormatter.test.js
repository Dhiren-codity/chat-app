  ...
  describe('MessageFormatter', () => {
    ...
    describe('extractUrls', () => {
      ...
      it('should handle URLs with query parameters', () => {
        const result = messageFormatter.extractUrls('Check this out: https://example.com?query=123&test=true');
        expect(result).toEqual(['https://example.com?query=123&test=true']);
      });
    });
  });
