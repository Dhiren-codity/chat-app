...
describe('MessageFormatter', () => {
  ...
  describe('MessageFormatter', () => {
    ...
    describe('formatTimestamp', () => {
      it('should return an empty string if timestamp is null', () => {
        expect(formatter.formatTimestamp(null)).toBe('');
      });
  
      it('should return an empty string if timestamp is undefined', () => {
        expect(formatter.formatTimestamp(undefined)).toBe('');
      });
  
      it('should return an empty string if timestamp is invalid', () => {
        expect(formatter.formatTimestamp('invalid')).toBe('');
      });
      ...
      it('should return "Just now" if the timestamp is less than a minute ago', () => {
        ...
        expect(formatter.formatTimestamp(timestamp)).toBe('Just now');
      });
      ...
      it('should return "1 minute ago" if the timestamp is exactly one minute ago', () => {
        ...
        expect(formatter.formatTimestamp(timestamp)).toBe('1 minute ago');
      });
      ...
      it('should return "5 minutes ago" if the timestamp is 5 minutes ago', () => {
        ...
        expect(formatter.formatTimestamp(timestamp)).toBe('5 minutes ago');
      });
      ...
      it('should return "1 hour ago" if the timestamp is exactly one hour ago', () => {
        ...
        expect(formatter.formatTimestamp(timestamp)).toBe('1 hour ago');
      });
      ...
      it('should return "3 hours ago" if the timestamp is 3 hours ago', () => {
        ...
        expect(formatter.formatTimestamp(timestamp)).toBe('3 hours ago');
      });
      ...
      it('should return "1 day ago" if the timestamp is exactly one day ago', () => {
        ...
        expect(formatter.formatTimestamp(timestamp)).toBe('1 day ago');
      });
      ...
      it('should return "3 days ago" if the timestamp is 3 days ago', () => {
        ...
        expect(formatter.formatTimestamp(timestamp)).toBe('3 days ago');
      });
      ...
      it('should return the date in locale format if the timestamp is more than 7 days ago', () => {
        ...
        expect(formatter.formatTimestamp(timestamp)).toBe(new Date(timestamp).toLocaleDateString());
      });
    });
  });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('truncateMessage', () => {
      it('should return an empty string if message is undefined', () => {
        expect(formatter.truncateMessage(undefined, 10)).toBe('');
      });
  
      it('should return an empty string if message is null', () => {
        expect(formatter.truncateMessage(null, 10)).toBe('');
      });
  
      it('should return the full message if its length is less than or equal to maxLength', () => {
        expect(formatter.truncateMessage('Hello', 10)).toBe('Hello');
      });
  
      it('should return the full message if its length is exactly maxLength', () => {
        expect(formatter.truncateMessage('HelloWorld', 10)).toBe('HelloWorld');
      });
  
      it('should truncate the message and add ellipsis if its length is greater than maxLength', () => {
        expect(formatter.truncateMessage('HelloWorld!', 10)).toBe('HelloW...');
      });
  
      it('should handle edge case where maxLength is less than or equal to 3', () => {
        expect(formatter.truncateMessage('HelloWorld!', 3)).toBe('...');
        expect(formatter.truncateMessage('HelloWorld!', 2)).toBe('...');
        expect(formatter.truncateMessage('HelloWorld!', 1)).toBe('...');
      });
  
      it('should handle edge case where maxLength is 0', () => {
        expect(formatter.truncateMessage('HelloWorld!', 0)).toBe('');
      });
    });
  });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('extractUrls', () => {
      ...
      it('should not match URLs without a protocol', () => {
        const result = messageFormatter.extractUrls('Visit www.example.com for more info.');
        expect(result).toEqual([]);
      });
  
      it('should handle URLs with query parameters', () => {
        const result = messageFormatter.extractUrls('Check this out: https://example.com?query=123');
        expect(result).toEqual(['https://example.com?query=123']);
      });
  
      it('should handle URLs with fragments', () => {
        const result = messageFormatter.extractUrls('Go to https://example.com#section1 for details.');
        expect(result).toEqual(['https://example.com#section1']);
      });
    });
  });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('linkifyUrls', () => {
      ...
      it('should handle URLs with query parameters', () => {
        const message = 'Search on https://example.com?query=test';
        const expected = 'Search on <a href="https://example.com?query=test" target="_blank" rel="noopener noreferrer">https://example.com?query=test</a>';
        expect(formatter.linkifyUrls(message)).toBe(expected);
      });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('methodToTest', () => {
      ...
      it('should handle messages without mentions or URLs', () => {
        const messageData = {
      ...
      it('should use "Unknown" as sender if sender is not provided', () => {
        const messageData = {
      ...
      it('should correctly extract multiple mentions and URLs', () => {
        const messageData = {
          content: '@user1 and @user2, visit http://example.com and https://another.com',
          timestamp: 1633072800000,
          sender: 'Alice'
        };
