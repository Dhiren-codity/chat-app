...
describe('MessageFormatter', () => {
  ...
  describe('MessageFormatter', () => {
    ...
    describe('formatTimestamp', () => {
      ...
      it('should return "Just now" if timestamp is less than a minute ago', () => {
        const now = new Date();
      ...
      it('should return "1 minute ago" if timestamp is exactly one minute ago', () => {
        const now = new Date();
      ...
      it('should return "5 minutes ago" if timestamp is 5 minutes ago', () => {
        const now = new Date();
      ...
      it('should return "1 hour ago" if timestamp is exactly one hour ago', () => {
        const now = new Date();
      ...
      it('should return "3 hours ago" if timestamp is 3 hours ago', () => {
        const now = new Date();
      ...
      it('should return "1 day ago" if timestamp is exactly one day ago', () => {
        const now = new Date();
      ...
      it('should return "2 days ago" if timestamp is 2 days ago', () => {
        const now = new Date();
      ...
      it('should return the date in locale format if timestamp is more than 7 days ago', () => {
        const now = new Date();
        const timestamp = new Date(now.getTime() - 8 * 86400000).toISOString(); // 8 days ago
  ...
  describe('MessageFormatter', () => {
    ...
    describe('methodToTest', () => {
      ...
      it('should return "Just now" for edge case 1', () => {
        const result = messageFormatter.methodToTest();
        expect(result).toBe('Just now');
      });
  
      it('should return "Just now" for edge case 2', () => {
        const result = messageFormatter.methodToTest();
        expect(result).toBe('Just now');
      });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('highlightMentions', () => {
      ...
      it('should handle mentions at the start and end of the message', () => {
        const message = '@start and end@';
        const expected = '<span class="mention">@start</span> and end@';
        expect(formatter.highlightMentions(message)).toBe(expected);
      });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('extractUrls', () => {
      ...
      it('should handle URLs with query parameters', () => {
        const result = messageFormatter.extractUrls('Search: https://example.com/search?q=test');
        expect(result).toEqual(['https://example.com/search?q=test']);
      });
  
      it('should handle URLs with ports', () => {
        const result = messageFormatter.extractUrls('Local server: http://localhost:3000');
  ...
  describe('MessageFormatter', () => {
    ...
    describe('linkifyUrls', () => {
      ...
      it('should handle URLs with trailing punctuation', () => {
        const message = 'Visit http://example.com.';
        const expected = 'Visit <a href="http://example.com" target="_blank" rel="noopener noreferrer">http://example.com</a>.';
        expect(formatter.linkifyUrls(message)).toBe(expected);
      });
  ...
  describe('MessageFormatter', () => {
    ...
    describe('formatMessage', () => {
      it('should return null if messageData is null', () => {
        const result = messageFormatter.formatMessage(null);
      ...
      it('should format message correctly with all fields', () => {
        ...
        jest.spyOn(messageFormatter, 'sanitizeMessage').mockReturnValue('Hello @user, check this out: http://example.com');
        jest.spyOn(messageFormatter, 'linkifyUrls').mockReturnValue('Hello @user, check this out: <a href="http://example.com">http://example.com</a>');
        jest.spyOn(messageFormatter, 'highlightMentions').mockReturnValue('Hello <span class="mention">@user</span>, check this out: <a href="http://example.com">http://example.com</a>');
        jest.spyOn(messageFormatter, 'formatTimestamp').mockReturnValue('2021-10-01T00:00:00Z');
        jest.spyOn(messageFormatter, 'extractMentions').mockReturnValue(['@user']);
        jest.spyOn(messageFormatter, 'extractUrls').mockReturnValue(['http://example.com']);
  
        const result = messageFormatter.formatMessage(messageData);
  
        expect(result).toEqual({
          content: 'Hello <span class="mention">@user</span>, check this out: <a href="http://example.com">http://example.com</a>',
      ...
      it('should handle missing sender by setting it to "Unknown"', () => {
        const messageData = {
          content: 'Hello world!',
          timestamp: 1633072800000
        };
  
        jest.spyOn(messageFormatter, 'sanitizeMessage').mockReturnValue('Hello world!');
        jest.spyOn(messageFormatter, 'linkifyUrls').mockReturnValue('Hello world!');
        jest.spyOn(messageFormatter, 'highlightMentions').mockReturnValue('Hello world!');
        jest.spyOn(messageFormatter, 'formatTimestamp').mockReturnValue('2021-10-01T00:00:00Z');
        jest.spyOn(messageFormatter, 'extractMentions').mockReturnValue([]);
        jest.spyOn(messageFormatter, 'extractUrls').mockReturnValue([]);
      ...
      it('should handle message with no mentions or URLs', () => {
        const messageData = {
        ...
        jest.spyOn(messageFormatter, 'sanitizeMessage').mockReturnValue('Just a simple message.');
        jest.spyOn(messageFormatter, 'linkifyUrls').mockReturnValue('Just a simple message.');
        jest.spyOn(messageFormatter, 'highlightMentions').mockReturnValue('Just a simple message.');
        jest.spyOn(messageFormatter, 'formatTimestamp').mockReturnValue('2021-10-01T00:00:00Z');
        jest.spyOn(messageFormatter, 'extractMentions').mockReturnValue([]);
        jest.spyOn(messageFormatter, 'extractUrls').mockReturnValue([]);
