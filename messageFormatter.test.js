  ...
  describe('MessageFormatter', () => {
    ...
    describe('extractUrls', () => {
      ...
      it('should handle URLs with query parameters', () => {
        const result = messageFormatter.extractUrls('Check this out: https://example.com?query=123&test=abc');
        expect(result).toEqual(['https://example.com?query=123&test=abc']);
      });
  
      it('should handle URLs with ports', () => {
        const result = messageFormatter.extractUrls('Access the server at http://localhost:8080');
