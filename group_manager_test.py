...
@pytest.mark.parametrize("group_id, new_name, user_id, expected", [
    ...
    (3, "Another Name", None, {'group_id': 3, 'new_name': "Another Name", 'updated_by': None, 'success': True}),  # Edge case: None user_id
])
...
@pytest.mark.parametrize("room_id, user_id, custom_title", [
    (None, 101, "Title"),  # Error case: room_id is None
    (1, None, "Title"),    # Error case: user_id is None
