...
@pytest.mark.parametrize("room_id, user_id, custom_title, expected", [
    ...
    (2, 101, "", {'room_id': 2, 'custom_title': "", 'user_id': 101}),
    # Edge case: Long custom title
    (3, 102, "A" * 256, {'room_id': 3, 'custom_title': "A" * 256, 'user_id': 102}),
    # Error case: Invalid room_id type
    ("invalid_id", 103, "Title", {'room_id': "invalid_id", 'custom_title': "Title", 'user_id': 103}),
])
