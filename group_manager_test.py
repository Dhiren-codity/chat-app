...
@pytest.mark.parametrize("room_id, user_id, custom_title, expected", [
    ...
    ("invalid_id", 104, "Conference Room", {'room_id': "invalid_id", 'custom_title': "Conference Room", 'user_id': 104}),
    # Error case: Invalid user_id type
    (4, "invalid_user", "Meeting Room", {'room_id': 4, 'custom_title': "Meeting Room", 'user_id': "invalid_user"}),
])
