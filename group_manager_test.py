...
@pytest.mark.parametrize("room_id, user_id, custom_title, expected", [
    (1, 100, "Study Room", {'room_id': 1, 'custom_title': "Study Room", 'user_id': 100}),
    (2, 200, "Meeting Room", {'room_id': 2, 'custom_title': "Meeting Room", 'user_id': 200}),
    (3, 300, "", {'room_id': 3, 'custom_title': "", 'user_id': 300}),  # Edge case: empty title
    (4, 400, "A" * 256, {'room_id': 4, 'custom_title': "A" * 256, 'user_id': 400}),  # Edge case: long title
