...
@pytest.mark.parametrize("room_id, user_id, custom_title, expected", [
    (1, 101, "Meeting Room", {'room_id': 1, 'custom_title': "Meeting Room", 'user_id': 101}),
    ...
    (None, 505, "Room 505", {'room_id': None, 'custom_title': "Room 505", 'user_id': 505}),  # Error case: None room_id
])
