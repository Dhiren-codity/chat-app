...
func TestCheckSpam(t *testing.T) {
	tests := []struct {
		...
		{"short message with caps", "HELLO", false, false, ""},
		{"exact boundary repetition", "word word word word word word word word word word word", true, true, "message appears to be spam (excessive repetition)"},
