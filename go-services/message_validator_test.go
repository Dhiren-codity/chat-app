...
func TestExtractMentions(t *testing.T) {
	tests := []struct {
		...
		{"no valid mentions", "Hello @", MentionValidator{MaxMentions: 5}, []string{}, false},
		{"mentions with special characters", "Hello @user_1", MentionValidator{MaxMentions: 5}, []string{"user_1"}, false},
	}
...
func TestExtractURLs(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "valid input with too many URLs",
