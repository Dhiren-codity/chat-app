...
func TestExtractURLs(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "content with exactly max URLs",
		...
		{
			name:     "content with more than max URLs",
...
func TestCheckSpam(t *testing.T) {
	tests := []struct {
		...
		{"mixed case", "This is a MIXED case message with SOME caps", false, false, ""},
		{"empty string", "", false, false, ""},
		{"just below repetition threshold", "word word word word word word word word word word", false, false, ""},
		{"just below caps threshold", "THIS IS A MESSAGE WITH CAPS", false, false, ""},
	}
