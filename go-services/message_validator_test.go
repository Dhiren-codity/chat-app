...
func TestCheckSpam(t *testing.T) {
	tests := []struct {
		...
		{"excessive caps", "THIS IS A SPAM MESSAGE WITH CAPS", true, true, "message appears to be spam (excessive caps)"},
		...
		{"mixed case with repetition", "Spam spam spam spam spam spam spam spam spam spam spam", true, true, "message appears to be spam (excessive repetition)"},
		{"mixed case with caps", "This is a SPAM MESSAGE with CAPS", true, true, "message appears to be spam (excessive caps)"},
	}
...
func TestAddBannedWord(t *testing.T) {
	tests := []struct {
		...
		{"empty input", "", []string{""}},
		{"duplicate input", "duplicate", []string{"duplicate", "duplicate"}},
	}
