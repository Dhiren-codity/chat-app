...
func TestCheckSpam(t *testing.T) {
	tests := []struct {
		...
		{"excessive caps", "THIS IS A MESSAGE WITH TOO MANY CAPS", true, true, "message appears to be spam (excessive caps)"},
...
func TestCountWords(t *testing.T) {
	tests := []struct {
		...
		{"input with newlines", "hello\nworld", 2},
		{"input with tabs", "hello\tworld", 2},
		{"input with mixed whitespace", "hello \t\n world", 2},
