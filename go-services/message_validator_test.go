...
func TestExtractMentions(t *testing.T) {
	tests := []struct {
		...
		{"mention with special characters", "Hello @user_name!", 5, []string{"user_name"}, false},
		{"mention at start", "@user1 hello", 5, []string{"user1"}, false},
		{"mention at end", "hello @user1", 5, []string{"user1"}, false},
	}
...
func TestExtractURLs(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "no URLs but exceeding maxURLs",
...
func TestSanitizeContent(t *testing.T) {
	tests := []struct {
		...
		{"replace multiple newlines", "Hello\n\n\nWorld", "Hello\n\nWorld"},
...
func TestCheckSpam(t *testing.T) {
	tests := []struct {
		...
		{"just below caps threshold", "THIS IS a message", false, false, ""},
		{"exactly at caps threshold", "THIS IS A MESSAGE", true, true, "message appears to be spam (excessive caps)"},
	}
