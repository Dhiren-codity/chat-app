...
class TestProfileManager:
    ...
    @pytest.mark.parametrize("user_id, display_name, expected", [
        ...
        (1, "A" * 256, {'user_id': 1, 'display_name': "A" * 256}),  # Edge case: very long display name
    ])

    def test_update_display_name(self, profile_manager, mock_user, user_id, display_name, expected):
