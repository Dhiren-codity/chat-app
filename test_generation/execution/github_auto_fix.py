    ...
    for test_file in test_files:
        ...
        try:
            ...
            if success:
                ...
                # VERIFY: Run tests to ensure they actually pass
                print(f"  🔍 Verifying tests pass after auto-fix...")
                success, stdout, stderr = auto_fixer.run_tests_and_capture_errors(
                    test_file, language
                )
                if success:
                    print(f"  ✅ Verification passed: tests are working")
                else:
                    print(f"  ⚠️ Verification failed: tests still have issues")
