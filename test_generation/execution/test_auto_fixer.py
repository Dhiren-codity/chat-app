...
"""
    ...
    def _keep_only_passing_tests_python(
        ...
        try:
            ...
            logger.info("  Step 1: Removing orphaned decorators...")
            ...
            print("  Step 2: Removing parametrize from fixtures...")
            logger.info("  Step 2: Removing parametrize from fixtures...")
            ...
            print("  Step 3: Removing tests with invalid signatures...")
            logger.info("  Step 3: Removing tests with invalid signatures...")
            cleaned_code = self._remove_tests_with_invalid_signatures(cleaned_code)

            # Final orphaned decorator cleanup
            logger.info("  Step 4: Final orphaned decorator cleanup...")
            cleaned_code = self._fix_syntax_errors_after_cleanup(cleaned_code)
    ...
    def _remove_tests_with_invalid_signatures(self, test_code: str) -> str:
        ...
        safe_names = known_fixtures | defined_fixtures | imported_names | known_names
