    ...
    def auto_fix_test(
        ...
        for attempt in range(1, self.max_retries + 1):
            ...
            if attempt == 2 and (error_info['errors'] or error_info['failures']):
                logger.warning("⚠️ Attempt 2 failed. Trying aggressive fallback: testing each function individually")
                ...
                if cleaned_code != current_code:
                    logger.info("✅ Created cleaned version - proceeding with attempt 3")
