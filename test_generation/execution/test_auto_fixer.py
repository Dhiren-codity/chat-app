...
"""
    ...
    def _ensure_pytest_import(self, test_code: str) -> str:
        ...
        logger.info("   ⚠️ pytest import missing - adding it at the top")

        # Find where to insert (after docstring, before other code)
        insert_index = 0
        in_docstring = False
        docstring_char = None
        ...
        for i, line in enumerate(lines):
            ...
            # If not in docstring and found first code, insert before it
