            ...
            if attempt == 1 and language == "python":
                ...
                if is_dependency_error:
                    ...
                    if "ModuleNotFoundError:" in combined_output:
                        ...
                        bad_test_imports = ['test_sample', 'sample_test', 'test_fixture', 'fixture_test', 'test_helpers', 'helpers_test']
                        fixable_bad_modules = [m for m in bad_modules if m in bad_test_imports]
                    ...
                    if remaining_tests > 0:
                        ...
                        if not verify_success:
                            ...
                            if failing_tests:
                                ...
                                logger.info(f"  Passing tests to keep: {passing_tests_list[:10]}")
                                ...
                                if cleaned_code_2:
                                    ...
                                    logger.error("❌ Second nuclear pass returned None!")
                                    logger.error("   This means keep_only_passing_tests() failed")
