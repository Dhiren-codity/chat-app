...
"""
    ...
    def _keep_only_passing_tests_python(
        ...
        try:
            ...
            if initial_passing_tests is not None and len(initial_passing_tests) > 0:
                ...
                logger.info(
                    f"🔍 Passing test base names: {list(passing_base_names)[:10]}"
                )
    ...
    def _create_basic_go_test_file(self, test_code: str) -> str:
        ...
        result_lines.append("package services")
        result_lines.append("")
    ...
    def _keep_only_passing_tests_java(
        ...
        try:
            ...
            logger.info(f"📋 Found {len(test_methods)} test methods")
    ...
    def _create_basic_java_test_file(self, test_code: str) -> str:
        ...
        # Add package declaration
        result_lines.append("package com.chatapp.services;")
        result_lines.append("")
        ...
        result_lines.append("public class UserServiceTest {")
        result_lines.append("")
