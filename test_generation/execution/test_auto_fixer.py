...
"""
    ...
    def auto_fix_test(
        ...
        # CRITICAL: Pre-scan for bad imports (test_sample, etc.) before running any tests
        # These prevent test collection, so must be removed early
        logger.info("🔍 Pre-scanning for bad test imports...")
        current_code = self._scan_and_remove_bad_imports(current_code)
