...
@pytest.mark.parametrize("password, expected", [
    ...
    ("noupper1!", {'valid': False, 'messages': ['Password must contain at least one uppercase letter']}),
])
...
@pytest.mark.parametrize("profile, expected", [
    # Happy path
    ({"username": "validUser", "email": "user@example.com", "password": "strongPass123", "display_name": "User"}, 
     {'valid': True, 'errors': {}}),
    # Error case: Invalid username
    ({"username": "us", "email": "user@example.com", "password": "strongPass123", "display_name": "User"}, 
     {'valid': False, 'errors': {'username': 'Invalid username format'}}),
    # Error case: Invalid email
    ({"username": "validUser", "email": "userexample.com", "password": "strongPass123", "display_name": "User"}, 
     {'valid': False, 'errors': {'email': 'Invalid email format'}}),
    # Edge case: Missing password
    ({"username": "validUser", "email": "user@example.com", "display_name": "User"}, 
     {'valid': True, 'errors': {}}),
    # Edge case: Invalid display name
    ({"username": "validUser", "email": "user@example.com", "password": "strongPass123", "display_name": ""}, 
     {'valid': False, 'errors': {'display_name': 'Invalid display name'}}),
])
