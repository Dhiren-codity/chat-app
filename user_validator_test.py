...
@pytest.mark.parametrize("profile, expected", [
    ...
    # Missing username
    ({"email": "user@example.com", "password": "strongpass"}, {'valid': False, 'errors': {'username': 'Invalid username format'}}),
    # Invalid email
    ...
    ({"username": "validuser", "email": "user@example.com", "password": "strongpass", "display_name": ""}, {'valid': False, 'errors': {'display_name': 'Invalid display name'}}),
])
