...
@pytest.mark.parametrize("email, expected", [
    ...
    ("user@domain.c", False),    # Edge case: domain too short
])
...
@pytest.mark.parametrize("password, expected", [
    ...
    ("ValidPass1!", {'valid': True, 'messages': []}),
])
...
@pytest.mark.parametrize("profile, expected", [
    ...
    ({"username": "validUser", "email": "user@example.com", "password": "short", "display_name": "User"},
