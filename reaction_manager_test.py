...
def test_get_reaction_count_happy_path_and_edge_cases(reaction_manager, message_id, mock_count, expected_count):
...
def test_bulk_add_reactions(reaction_manager, reactions, add_reaction_results, expected):
    reaction_manager.add_reaction.side_effect = add_reaction_results
