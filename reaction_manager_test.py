...
def test_get_allowed_emojis_type(reaction_manager):
    assert isinstance(reaction_manager.get_allowed_emojis(), list)


def test_get_allowed_emojis_not_none(reaction_manager):
    assert reaction_manager.get_allowed_emojis() is not None