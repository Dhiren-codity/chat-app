...
def test_reaction_manager_init_with_none_db_session(mocker):
    # Test with None db_session to ensure default is used
    mocker.patch('reaction_manager.db', "default_db")
    reaction_manager = ReactionManager(db_session=None)
