...
def test_reaction_manager_init_with_invalid_session():
    with pytest.raises(AttributeError):
        manager = ReactionManager(db_session="invalid_session")
...
class MessageReaction:
    ...
    def query():
        return MagicMock()
# Test cases for get_user_reactions
...
def test_get_user_reactions_error(user_id, message_id):
    # Create instance of ReactionManager
    reaction_manager = ReactionManager()
...
class TestReactionManager:
    ...
    def test_has_user_reacted(self, reaction_manager, message_id, user_id, emoji, expected):
        ...
        MessageReaction.query = MagicMock(return_value=mock_query)
...
def test_get_allowed_emojis_content(reaction_manager, expected_emojis):
    assert set(reaction_manager.get_allowed_emojis()) == set(expected_emojis)
