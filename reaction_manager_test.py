...
def test_get_reaction_count_happy_path(reaction_manager, message_id, mock_count, expected_count):
    # Mock the count method to return mock_count
...
def test_get_reaction_count_error_case(reaction_manager):
    ...
    with pytest.raises(Exception, match="Database error"):
        reaction_manager.get_reaction_count(999)  # Using a random message_id
...
@pytest.mark.parametrize("reactions, expected", [
    ...
    (
        ...
        {'total': 3, 'added': 2, 'failed': 1, 'errors': ["Emoji '🚀' not allowed."]}
    ),
