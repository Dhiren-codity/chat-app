...
@pytest.mark.parametrize("message_id, user_id, emoji, message_exists, reaction_exists, expected", [
    ...
    (1, 1, ":invalid:", True, False, pytest.raises(ValueError)),
    (1, 1, ":smile:", False, False, pytest.raises(ValueError)),
...
def test_get_allowed_emojis_edge_case_modify_list(reaction_manager, modify_list):
