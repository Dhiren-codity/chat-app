...
@pytest.mark.parametrize("room_id, user_id, messages, expected", [
    # Happy path: multiple messages with complete data
    (1, 1, [
        Message(1, 1, 1, 'sent', datetime(2023, 10, 1, 12, 0), datetime(2023, 10, 1, 12, 5), datetime(2023, 10, 1, 12, 10)),
        Message(2, 1, 1, 'delivered', datetime(2023, 10, 1, 12, 15), datetime(2023, 10, 1, 12, 20), None)
    ], [
    ...
    (1, 2, [], []),
    # Edge case: message with no sent_at, delivered_at, or read_at
    (1, 1, [
        Message(3, 1, 1, 'pending', None, None, None)
    ], [
        {'message_id': 3, 'status': 'pending', 'sent_at': None, 'delivered_at': None, 'read_at': None}
    ]),
