...
@pytest.mark.parametrize("message_id, user_id, message_user_id, expected_status", [
    (1, 2, 3, 'read'),  # Happy path: valid message and user
...
@pytest.mark.parametrize("room_id, user_id, messages, expected", [
    ...
    (1, 1, [
        ...
        Message(3, 1, 1, 'read', datetime(2023, 10, 1, 10, 10, 0), datetime(2023, 10, 1, 10, 11, 0), datetime(2023, 10, 1, 10, 12, 0))
    ], [
        ...
        {'message_id': 3, 'status': 'read', 'sent_at': '2023-10-01T10:10:00', 'delivered_at': '2023-10-01T10:11:00', 'read_at': '2023-10-01T10:12:00'}
    ]),
    # Edge case: no messages in the room
    (2, 1, [], []),
    # Edge case: messages with null timestamps
    (3, 1, [
        Message(4, 3, 1, 'sent', None, None, None)
    ], [
