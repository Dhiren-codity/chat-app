...
def test_mark_as_delivered(message_status_manager, message_id, user_id, message_exists, same_user, expected):
    # Setup
    message = Message(message_id, user_id if same_user else user_id + 1)
    if message_exists:
...
@pytest.mark.parametrize("message_id, message, expected", [
    ...
    (2, Message(2, 'delivered', None, '2023-10-01T12:00:00', None), {
        'message_id': 2,
        'status': 'delivered',
        'sent_at': None,
        'delivered_at': '2023-10-01T12:00:00',
        'read_at': None
    }),
...
@pytest.mark.parametrize("message_id, message, expected", [
    (4, Message(4, 'read', '2023-10-01T10:00:00', '2023-10-01T11:00:00', '2023-10-01T12:00:00'), {
        'message_id': 4,
        'status': 'read',
        'sent_at': '2023-10-01T10:00:00',
        'delivered_at': '2023-10-01T11:00:00',
        'read_at': '2023-10-01T12:00:00'
    }),
    (5, Message(5, 'sent', '2023-10-01T09:00:00', None, None), {
        'message_id': 5,
        'status': 'sent',
...
@pytest.mark.parametrize("room_id, user_id, messages, expected", [
    ...
    (2, 1, [
        Message(3, 2, 1, 'read', datetime(2023, 10, 2, 11, 0, 0), datetime(2023, 10, 2, 11, 1, 0), datetime(2023, 10, 2, 11, 2, 0))
    ], [
        {'message_id': 3, 'status': 'read', 'sent_at': '2023-10-02T11:00:00', 'delivered_at': '2023-10-02T11:01:00', 'read_at': '2023-10-02T11:02:00'}
    ]),
])
