...
def test_mark_as_delivered(message_status_manager, mock_message, message_id, user_id, message_exists, same_user, expected):
    if message_exists:
        ...
        mock_message.user_id = user_id if same_user else mock_message.user_id
    else:
...
@pytest.mark.parametrize("room_id, user_id, messages, expected", [
    (1, 1, [
        Message(1, 'sent', datetime(2023, 10, 1, 10, 0, 0), None, None),
        Message(2, 'delivered', datetime(2023, 10, 1, 10, 5, 0), datetime(2023, 10, 1, 10, 6, 0), None)
    ], [
    ...
    (2, 1, [
        Message(3, 'read', datetime(2023, 10, 2, 11, 0, 0), datetime(2023, 10, 2, 11, 1, 0), datetime(2023, 10, 2, 11, 2, 0))
    ], [
