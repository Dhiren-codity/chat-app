...
@pytest.mark.parametrize("room_id, user_id, messages, expected", [
    (1, 1, [
        Message(1, 1, 1, 'sent', datetime(2023, 10, 1, 10, 0, 0)),
        Message(2, 1, 1, 'delivered', datetime(2023, 10, 1, 10, 5, 0), datetime(2023, 10, 1, 10, 6, 0)),
    ], [
    ...
    (2, 1, [
        Message(3, 2, 1, 'read', datetime(2023, 10, 1, 11, 0, 0), datetime(2023, 10, 1, 11, 1, 0), datetime(2023, 10, 1, 11, 2, 0)),
    ], [
        {'message_id': 3, 'status': 'read', 'sent_at': '2023-10-01T11:00:00', 'delivered_at': '2023-10-01T11:01:00', 'read_at': '2023-10-01T11:02:00'},
    ]),
])
