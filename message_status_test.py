...
@pytest.mark.parametrize("message_id, user_id, expected", [
    ...
    (1, 1, None),  # Error case: user_id is the sender
    (None, 2, None),  # Edge case: message_id is None
    (999, 2, None),  # Edge case: message does not exist
])
...
@pytest.mark.parametrize("message_id, user_id, message_user_id, expected_status", [
    ...
    (2, 3, 3, None),    # Error case: user_id is the same as message_user_id
...
@pytest.mark.parametrize("room_id, user_id, messages, expected", [
    ...
    (1, 3, [
        Message(4, 1, 3, 'sent', None, None, None)
    ], [
