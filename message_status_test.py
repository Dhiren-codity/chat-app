...
@pytest.mark.parametrize("test_input,expected", [
    ...
    (1, True),     # Edge case: passing an integer (should still create an instance)
    ("test", True) # Edge case: passing a string (should still create an instance)
])
...
def test_message_status_manager_init(test_input, expected):
    if test_input is None:
        ...
        manager = MessageStatusManager()  # __init__ doesn't take parameters
