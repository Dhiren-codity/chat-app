...
describe('ChatUtils', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      ...
      // Add more tests for various inputs if applicable
    });
  });
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      it('should return grouped data for a valid input', () => {
        ...
        const result = chatUtils.methodToTest(input);
      ...
      it('should handle input with mixed group types', () => {
        const input = [
        { id: 1, group: 'A' },
        { id: 2, group: 1 },
        { id: 3, group: 'A' },
      ...
      it('should handle input with null or undefined values', () => {
        ...
        const expectedOutput = {
          null: [{ id: 1, group: null }],
          undefined: [{ id: 2, group: undefined }],
          A: [{ id: 3, group: 'A' }]
        };
        const result = chatUtils.methodToTest(input);
        expect(result).toEqual(expectedOutput);
  ...
  describe('ChatUtils', () => {
    ...
    describe('filterMessagesBySender', () => {
      ...
      it('should return an empty array when senderId is null', () => {
        const messages = [
        { senderId: '123', text: 'Hello' },
        { senderId: '456', text: 'Hi' }
        ];
        const result = chatUtils.filterMessagesBySender(messages, null);
        expect(result).toEqual([]);
      });
  
      it('should return an empty array when senderId is undefined', () => {
        const messages = [
        { senderId: '123', text: 'Hello' },
        { senderId: '456', text: 'Hi' }
        ];
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      ...
      it('should return undefined for valid string input', () => {
        const result = chatUtils.methodToTest('Hello, world!');
        expect(result).toBeUndefined();
      });
