...
describe('ChatUtils', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('formatMinutesAgo', () => {
      ...
      it('should return "60 minutes ago" for 60 minutes', () => {
        const result = chatUtils.formatMinutesAgo(60);
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      ...
      it('should return 0 for a numeric input', () => {
        const result = chatUtils.methodToTest(123);
        expect(result).toBe(0);
      });
  ...
  describe('ChatUtils', () => {
    ...
    describe('groupMessagesByDate', () => {
      it('should return an empty map when messages array is empty', () => {
        const messages: Message[] = [];
        const result = chatUtils.groupMessagesByDate(messages);
        expect(result.size).toBe(0);
      });
  
      it('should return an empty map when messages is undefined', () => {
        const result = chatUtils.groupMessagesByDate(undefined);
        expect(result.size).toBe(0);
      });
  
      it('should group messages by the same date', () => {
        const date = new Date();
        const messages: Message[] = [
        { timestamp: date, content: 'Hello' },
        { timestamp: date, content: 'World' }
        ];
        const result = chatUtils.groupMessagesByDate(messages);
        expect(result.size).toBe(1);
        expect(result.get(date.toDateString())!.length).toBe(2);
      });
  
      it('should group messages by different dates', () => {
        const date1 = new Date('2023-01-01');
        const date2 = new Date('2023-01-02');
        const messages: Message[] = [
        { timestamp: date1, content: 'Message 1' },
        { timestamp: date2, content: 'Message 2' }
        ];
        const result = chatUtils.groupMessagesByDate(messages);
        expect(result.size).toBe(2);
        expect(result.get(date1.toDateString())!.length).toBe(1);
        expect(result.get(date2.toDateString())!.length).toBe(1);
      });
  
      it('should handle messages with the same timestamp correctly', () => {
        const date = new Date('2023-01-01');
        const messages: Message[] = [
        { timestamp: date, content: 'Message 1' },
        { timestamp: date, content: 'Message 2' },
        { timestamp: date, content: 'Message 3' }
        ];
        const result = chatUtils.groupMessagesByDate(messages);
        expect(result.size).toBe(1);
        expect(result.get(date.toDateString())!.length).toBe(3);
      });
    });
  });
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      ...
      it('should return an empty array for function input', () => {
        const result = chatUtils.methodToTest(() => {});
        expect(result).toEqual([]);
      });
    });
  ...
  describe('ChatUtils', () => {
    let chatUtils: ChatUtils;
    const maxLength = 100; // Adjust maxLength as necessary
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      it('should return false for happy path input', () => {
