...
describe('ChatUtils', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('hasUnreadMessages', () => {
      ...
      it('should return true if there are unread messages between room participants', () => {
        ...
        const result = chatUtils.hasUnreadMessages(room, messages, 'user1');
  ...
  describe('ChatUtils', () => {
    ...
    describe('formatRoomName', () => {
      ...
      it('should return "Group Chat" with participant count if room name is empty', () => {
        const room = { name: '   ', participants: ['user1', 'user2', 'user3'] };
        const result = chatUtils.formatRoomName(room, 'user1', []);
        expect(result).toBe('Group Chat (3 members)');
      });
  ...
  describe('ChatUtils', () => {
    ...
    describe('isValidMessageContent', () => {
      ...
      it('should return false if content length exceeds maxLength', () => {
        ...
        expect(chatUtils.isValidMessageContent(longString, maxLength)).toBe(false);
      });
  
      it('should return true for valid content within maxLength', () => {
        const validString = 'Hello, world!';
        expect(chatUtils.isValidMessageContent(validString, maxLength)).toBe(true);
      });
  
      it('should return true for content exactly at maxLength', () => {
        const exactLengthString = 'a'.repeat(maxLength);
        expect(chatUtils.isValidMessageContent(exactLengthString, maxLength)).toBe(true);
      });
    });
  });
