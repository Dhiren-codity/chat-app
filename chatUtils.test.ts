...
describe('ChatUtils', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      ...
      it('should handle edge case 1', () => {
        // Assuming edge case 1 is defined, replace with actual test
        const result = chatUtils.methodToTest();
        expect(result).toBe('Just now');
      });
  
      it('should handle edge case 2', () => {
        // Assuming edge case 2 is defined, replace with actual test
        const result = chatUtils.methodToTest();
        expect(result).toBe('Just now');
      });
  
      // Add more tests as needed for various inputs
    });
  });
  ...
  describe('ChatUtils', () => {
    ...
    describe('formatHoursAgo', () => {
      ...
      it('should return "24 hours ago" for 24 hours difference', () => {
        const result = chatUtils.formatHoursAgo(24);
        expect(result).toBe('24 hours ago');
      });
  
      it('should return "1 hour ago" for negative 1 hour difference', () => {
        const result = chatUtils.formatHoursAgo(-1);
        expect(result).toBe('1 hour ago');
      });
  ...
  describe('ChatUtils', () => {
    ...
    describe('hasUnreadMessages', () => {
      ...
      it('should return false if no messages are between room participants', () => {
        ...
        const result = chatUtils.hasUnreadMessages(room, messages, 'userId1');
        expect(result).toBe(false);
      });
  ...
  describe('ChatUtils', () => {
    ...
    describe('isParticipant', () => {
      ...
      it('should return false if participants array is empty', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('getUserDisplayName', () => {
      ...
      it('should handle user object with missing firstName and lastName properties', () => {
        const user = {};
        const displayName = chatUtils.getUserDisplayName(user);
        expect(displayName).toBe('Anonymous');
      });
