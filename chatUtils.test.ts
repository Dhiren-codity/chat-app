...
describe('ChatUtils', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('isParticipant', () => {
      ...
      it('should return false if userId is not in room.participants', () => {
        const room = { participants: ['user2', 'user3'] };
        const result = chatUtils.isParticipant(room, 'user1');
        expect(result).toBe(false);
      });
  
      it('should return true if userId is in room.participants', () => {
        const room = { participants: ['user1', 'user2', 'user3'] };
        const result = chatUtils.isParticipant(room, 'user1');
        expect(result).toBe(true);
      });
  
      it('should return false if room.participants is an empty array', () => {
