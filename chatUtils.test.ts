...
describe('ChatUtils', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('getLastSeenText', () => {
      ...
      it('should return "3 hours ago" if lastSeen is 3 hours ago', () => {
        const now = new Date();
        const lastSeen = new Date(now.getTime() - 10800000); // 3 hours ago
      ...
      it('should return "10 days ago" if lastSeen is 10 days ago', () => {
        const now = new Date();
        const lastSeen = new Date(now.getTime() - 864000000); // 10 days ago
        expect(chatUtils.getLastSeenText(lastSeen)).toBe('10 days ago');
      });
  
      it('should return the date if lastSeen is more than 30 days ago', () => {
        const now = new Date();
        const lastSeen = new Date(now.getTime() - 2592000000); // 30 days ago
  ...
  describe('ChatUtils', () => {
    ...
    describe('isParticipant', () => {
      ...
      it('should return false if room has no participants', () => {
      ...
      it('should handle undefined userId gracefully', () => {
        const room = { participants: ['user1', 'user2'] };
        const result = chatUtils.isParticipant(room, undefined);
        expect(result).toBe(false);
      });
    });
  });
