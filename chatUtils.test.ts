...
describe('ChatUtils', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('getUserDisplayName', () => {
      it('should return "Unknown User" if user is null', () => {
        const result = chatUtils.getUserDisplayName(null);
        expect(result).toBe('Unknown User');
      });
  
      it('should return "Unknown User" if user is undefined', () => {
        const result = chatUtils.getUserDisplayName(undefined);
        expect(result).toBe('Unknown User');
      });
  
      it('should return displayName if it exists', () => {
        const user = { displayName: 'John Doe', username: 'johndoe' };
        const result = chatUtils.getUserDisplayName(user);
        expect(result).toBe('John Doe');
      });
  
      it('should return username if displayName does not exist', () => {
        const user = { username: 'johndoe' };
        const result = chatUtils.getUserDisplayName(user);
        expect(result).toBe('johndoe');
      });
  
      it('should return "Unknown User" if neither displayName nor username exist', () => {
        const user = {};
        const result = chatUtils.getUserDisplayName(user);
        expect(result).toBe('Unknown User');
      });
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      it('should return "1 day ago" for diffDays = 1', () => {
        const diffDays = 1;
        const result = chatUtils.methodToTest(diffDays);
      ...
      it('should return "-1 days ago" for diffDays = -1', () => {
        const diffDays = -1;
        const result = chatUtils.methodToTest(diffDays);
  ...
  describe('ChatUtils', () => {
    ...
    describe('isMessageRead', () => {
      ...
      it('should return false if message is a string', () => {
        const message = "This is a string";
        expect(chatUtils.isMessageRead(message)).toBe(false);
      });
  
      it('should return false if message is a number', () => {
        const message = 123;
        expect(chatUtils.isMessageRead(message)).toBe(false);
      });
  
      it('should return false if message is an array', () => {
        const message = [];
        expect(chatUtils.isMessageRead(message)).toBe(false);
      });
    });
  ...
  describe('ChatUtils', () => {
    ...
    describe('isMessageDelivered', () => {
      ...
      it('should return false when message is an empty object', () => {
        const message = {};
        expect(chatUtils.isMessageDelivered(message)).toBe(false);
      });
  
      it('should return false when message has delivered property with non-boolean value', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('getUnreadCount', () => {
      ...
      it('should handle messages with mixed read status correctly', () => {
        const messages = [
        { recipientId: 'user1', read: false },
        { recipientId: 'user1', read: true },
        { recipientId: 'user1', read: false },
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      ...
      it('should handle input with mixed types', () => {
        const input = [
        { id: 1, group: 'A' },
        'string',
        { id: 2, group: 'B' },
  ...
  describe('ChatUtils', () => {
    ...
    describe('filterMessagesBySender', () => {
      ...
      it('should return only messages that match the senderId', () => {
        const messages = [
        { senderId: '123', content: 'Hello' },
        { senderId: '456', content: 'Hi' },
        { senderId: '123', content: 'How are you?' }
        ];
        const result = chatUtils.filterMessagesBySender(messages, '123');
        expect(result).toEqual([
          { senderId: '123', content: 'Hello' },
      ...
      it('should return an empty array when senderId is not provided', () => {
        ...
        const result = chatUtils.filterMessagesBySender(messages, '');
        expect(result).toEqual([]);
      });
    });
  });
  ...
  describe('ChatUtils', () => {
    ...
    describe('getOtherParticipants', () => {
      ...
      it('should return an empty array if room has no participants', () => {
      ...
      it('should return all participants if userId is not in the participants list', () => {
        const room = { participants: ['user2', 'user3'] };
        const result = chatUtils.getOtherParticipants(room, 'user1');
        expect(result).toEqual(['user2', 'user3']);
      });
  
      it('should return an empty array if the only participant is the userId', () => {
