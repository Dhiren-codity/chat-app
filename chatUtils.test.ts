...
describe('ChatUtils', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      ...
      it('should return "Unknown User" for valid string input', () => {
        const result = chatUtils.methodToTest('John Doe');
        expect(result).toBe('Unknown User');
      });
    });
  });
  ...
  describe('ChatUtils', () => {
    ...
    describe('getLastSeenText', () => {
      ...
      it('should return "Just now" if lastSeen is less than a minute ago', () => {
        const lastSeen = new Date(Date.now() - 30000); // 30 seconds ago
      ...
      it('should return "5 minutes ago" if lastSeen is 5 minutes ago', () => {
        const lastSeen = new Date(Date.now() - 5 * 60000); // 5 minutes ago
      ...
      it('should return "3 hours ago" if lastSeen is 3 hours ago', () => {
        const lastSeen = new Date(Date.now() - 3 * 3600000); // 3 hours ago
      ...
      it('should return "10 days ago" if lastSeen is 10 days ago', () => {
        const lastSeen = new Date(Date.now() - 10 * 86400000); // 10 days ago
      ...
      it('should return the date string if lastSeen is more than 30 days ago', () => {
        const lastSeen = new Date(Date.now() - 31 * 86400000); // 31 days ago
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      it('should return "Never" for any input', () => {
        expect(chatUtils.methodToTest()).toBe('Never');
        expect(chatUtils.methodToTest('')).toBe('Never');
        expect(chatUtils.methodToTest(null)).toBe('Never');
        expect(chatUtils.methodToTest(undefined)).toBe('Never');
        expect(chatUtils.methodToTest(123)).toBe('Never');
        expect(chatUtils.methodToTest({})).toBe('Never');
        expect(chatUtils.methodToTest([])).toBe('Never');
        expect(chatUtils.methodToTest(true)).toBe('Never');
        expect(chatUtils.methodToTest(false)).toBe('Never');
      });
    });
  });
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      it('should return "Just now" for the current time', () => {
        const result = chatUtils.methodToTest(new Date());
        expect(result).toBe('Just now');
      });
  
      it('should return "Just now" for a time within the last minute', () => {
        const date = new Date();
        date.setSeconds(date.getSeconds() - 30);
        const result = chatUtils.methodToTest(date);
        expect(result).toBe('Just now');
      });
  
      it('should return "Just now" for a time exactly one minute ago', () => {
        const date = new Date();
      ...
      it('should not return "Just now" for a time more than one minute ago', () => {
        const date = new Date();
      ...
      it('should handle edge case of future date', () => {
        const date = new Date();
        date.setMinutes(date.getMinutes() + 1);
        const result = chatUtils.methodToTest(date);
        expect(result).not.toBe('Just now');
  ...
  describe('ChatUtils', () => {
    ...
    describe('method to test', () => {
      it('should return "1 minute ago" when diffMins is 1', () => {
        const result = chatUtils.methodToTest(1);
        expect(result).toBe('1 minute ago');
      });
  
      it('should return "2 minutes ago" when diffMins is 2', () => {
        const result = chatUtils.methodToTest(2);
        expect(result).toBe('2 minutes ago');
      });
  
      it('should return "0 minutes ago" when diffMins is 0', () => {
        const result = chatUtils.methodToTest(0);
        expect(result).toBe('0 minutes ago');
      });
  
      it('should return "59 minutes ago" when diffMins is 59', () => {
        const result = chatUtils.methodToTest(59);
        expect(result).toBe('59 minutes ago');
      });
  
      it('should return "60 minutes ago" when diffMins is 60', () => {
        const result = chatUtils.methodToTest(60);
        expect(result).toBe('60 minutes ago');
      });
  
      it('should return "100 minutes ago" when diffMins is 100', () => {
        const result = chatUtils.methodToTest(100);
        expect(result).toBe('100 minutes ago');
      });
    });
  });
  ...
  describe('ChatUtils', () => {
    ...
    describe('formatHoursAgo', () => {
      it('should return "1 hour ago" for 1 hour difference', () => {
        const diffHours = 1;
        const result = chatUtils.formatHoursAgo(diffHours);
        expect(result).toBe('1 hour ago');
      });
  
      it('should return "2 hours ago" for 2 hours difference', () => {
        const diffHours = 2;
        const result = chatUtils.formatHoursAgo(diffHours);
        expect(result).toBe('2 hours ago');
      });
  
      it('should return "0 hours ago" for 0 hours difference', () => {
        const diffHours = 0;
        const result = chatUtils.formatHoursAgo(diffHours);
        expect(result).toBe('0 hours ago');
      });
  
      it('should return "-1 hours ago" for negative hour difference', () => {
        const diffHours = -1;
        const result = chatUtils.formatHoursAgo(diffHours);
        expect(result).toBe('-1 hours ago');
      });
  
      it('should handle large hour differences correctly', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('isMessageRead', () => {
      it('should return true if message is defined and read is true', () => {
        const message = { read: true };
        expect(chatUtils.isMessageRead(message)).toBe(true);
      });
  
      it('should return false if message is defined and read is false', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('getUnreadCount', () => {
      it('should return 0 if messages is null', () => {
        const result = chatUtils.getUnreadCount(null, 'user1');
        expect(result).toBe(0);
      });
  
      it('should return 0 if messages is an empty array', () => {
      ...
      it('should return 0 if all messages for the user are read', () => {
        const messages = [
        { recipientId: 'user1', read: true },
        { recipientId: 'user1', read: true },
        ];
      ...
      it('should return 0 if there are no messages for the user', () => {
        const messages = [
        { recipientId: 'user2', read: false },
        { recipientId: 'user2', read: true },
        ];
        const result = chatUtils.getUnreadCount(messages, 'user1');
        expect(result).toBe(0);
      });
  ...
  describe('ChatUtils', () => {
    ...
    describe('groupMessagesByDate', () => {
      ...
      it('should handle messages with different time zones', () => {
        const messages = [
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      it('should return grouped data for a valid input', () => {
        const input = [
        { id: 1, group: 'A', message: 'Hello' },
        { id: 2, group: 'B', message: 'Hi' },
        { id: 3, group: 'A', message: 'Hey' }
        ];
      ...
      it('should handle input with no group field', () => {
        const input = [
        { id: 1, message: 'Hello' },
        { id: 2, message: 'Hi' }
        ];
      ...
      it('should handle input with null or undefined values', () => {
        const input = [
        { id: 1, group: 'A', message: 'Hello' },
        null,
        undefined,
      ...
      it('should handle input with mixed valid and invalid entries', () => {
        const input = [
        { id: 1, group: 'A', message: 'Hello' },
        { id: 2, message: 'Hi' },
        { id: 3, group: 'A', message: 'Hey' }
  ...
  describe('ChatUtils', () => {
    ...
    describe('hasUnreadMessages', () => {
      ...
      it('should return false if messages is null', () => {
        const room = { participants: ['userId1', 'userId2'] };
      ...
      it('should return false if no messages are between room participants', () => {
        const room = { participants: ['userId1', 'userId2'] };
        const messages = [
        { senderId: 'userId3', recipientId: 'userId4' }
        ];
      ...
      it('should return true if there are unread messages between room participants', () => {
        ...
        const result = chatUtils.hasUnreadMessages(room, messages, 'userId2');
  ...
  describe('ChatUtils', () => {
    ...
    describe('getLatestMessage', () => {
      it('should return undefined if room is not provided', () => {
        const result = chatUtils.getLatestMessage(undefined, []);
        expect(result).toBeUndefined();
      });
  
      it('should return undefined if messages are not provided', () => {
        const room = { participants: ['user1', 'user2'] };
        const result = chatUtils.getLatestMessage(room, undefined);
        expect(result).toBeUndefined();
      });
  
      it('should return undefined if messages array is empty', () => {
        const room = { participants: ['user1', 'user2'] };
      ...
      it('should return undefined if no messages are between room participants', () => {
        ...
        { senderId: 'user5', recipientId: 'user6', timestamp: 2 }
        ];
      ...
      it('should return the latest message between room participants', () => {
        ...
        { senderId: 'user2', recipientId: 'user1', timestamp: 3 },
        { senderId: 'user1', recipientId: 'user2', timestamp: 2 }
        ];
        ...
        const result = chatUtils.getLatestMessage(room, messages);
        expect(result).toEqual({ senderId: 'user2', recipientId: 'user1', timestamp: 3 });
      });
    });
  });
  ...
  describe('ChatUtils', () => {
    ...
    describe('getOtherParticipants', () => {
      ...
      it('should handle duplicate userIds correctly', () => {
        const room = { participants: ['user1', 'user1', 'user2'] };
        const result = chatUtils.getOtherParticipants(room, 'user1');
  ...
  describe('ChatUtils', () => {
    ...
    describe('formatRoomName', () => {
      ...
      it('should return room name if it is non-empty', () => {
      ...
      it('should return "Unknown User" if there is one other participant and user is not found', () => {
        ...
        jest.spyOn(chatUtils, 'getOtherParticipants').mockReturnValue(['user2']);
        const result = chatUtils.formatRoomName(room, 'user1', []);
        expect(result).toBe('Unknown User');
      });
  
      it('should return the display name of the other user if there is one other participant', () => {
        const room = { name: '', participants: ['user1', 'user2'] };
      ...
      it('should return "Group Chat" with participant count if there are multiple participants', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('getOtherUserDisplayName', () => {
      it('should return the display name of the other user when the user is found', () => {
        const users = [
        { id: '1', name: 'Alice' },
        { id: '2', name: 'Bob' }
        ];
  ...
  describe('ChatUtils', () => {
    ...
    describe('getUserDisplayName', () => {
      it('should return the correct display name for a user with a first and last name', () => {
      ...
      it('should handle user object with undefined first and last names', () => {
