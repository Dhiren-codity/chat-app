...
describe('ChatUtils', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      ...
      it('should not return "Just now" for a time more than a minute ago', () => {
        const date = new Date();
  ...
  describe('ChatUtils', () => {
    ...
    describe('formatDaysAgo', () => {
      it('should return "1 day ago" for 1 day difference', () => {
        const result = chatUtils.formatDaysAgo(1);
        expect(result).toBe('1 day ago');
      });
  
      it('should return "2 days ago" for 2 days difference', () => {
        const result = chatUtils.formatDaysAgo(2);
        expect(result).toBe('2 days ago');
      });
  
      it('should return "0 days ago" for 0 day difference', () => {
        const result = chatUtils.formatDaysAgo(0);
        expect(result).toBe('0 days ago');
      });
  
      it('should return "100 days ago" for 100 days difference', () => {
        const result = chatUtils.formatDaysAgo(100);
        expect(result).toBe('100 days ago');
      });
  
      it('should handle negative day difference gracefully', () => {
        const result = chatUtils.formatDaysAgo(-1);
  ...
  describe('ChatUtils', () => {
    ...
    describe('getUnreadCount', () => {
      ...
      it('should handle messages with mixed read status and recipients', () => {
        const messages = [
        { recipientId: 'user1', read: false },
        { recipientId: 'user2', read: false },
        { recipientId: 'user1', read: true },
  ...
  describe('ChatUtils', () => {
    ...
    describe('getLatestMessage', () => {
      ...
      it('should return undefined if sortMessagesByTime returns an empty array', () => {
        const room = { participants: ['user1', 'user2'] };
        const messages = [
        { senderId: 'user1', recipientId: 'user2', timestamp: 1 }
        ];
  ...
  describe('ChatUtils', () => {
    ...
    describe('getOtherUserDisplayName', () => {
      it('should return the display name of the other user when user is found', () => {
        const users = [
        { id: '1', name: 'Alice' },
        { id: '2', name: 'Bob' }
        ];
      ...
      it('should return "Unknown User" when user is not found', () => {
        const users = [
        { id: '1', name: 'Alice' },
        { id: '2', name: 'Bob' }
        ];
  ...
  describe('ChatUtils', () => {
    ...
    describe('isValidMessageContent', () => {
      ...
      it('should return false for content longer than maxLength', () => {
      ...
      it('should return true for content exactly maxLength', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      it('should return false for a happy path input', () => {
        const result = chatUtils.methodToTest('happyPathInput');
        expect(result).toBe(false);
      });
      ...
      it('should return false for an array input', () => {
        const result = chatUtils.methodToTest(['array', 'input']);
        expect(result).toBe(false);
      });
    });
  });
