...
describe('ChatUtils', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      ...
      it('should handle input with mixed group and no group fields', () => {
        const input = [
        { id: 1, group: 'A', message: 'Hello' },
        { id: 2, message: 'Hi' },
        { id: 3, group: 'A', message: 'Hey' }
      ...
      it('should handle input with multiple groups', () => {
        const input = [
        { id: 1, group: 'A', message: 'Hello' },
        { id: 2, group: 'B', message: 'Hi' },
        { id: 3, group: 'C', message: 'Hey' },
        { id: 4, group: 'A', message: 'Hola' }
        ];
        const expectedOutput = {
          A: [
          { id: 1, group: 'A', message: 'Hello' },
  ...
  describe('ChatUtils', () => {
    ...
    describe('formatRoomName', () => {
      ...
      it('should return the display name of the other participant if there is one other participant', () => {
        const room = { name: '', participants: ['user1', 'user2'] };
