...
describe('ChatUtils', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      ...
      // Add more test cases for edge cases if applicable
      // Example:
  ...
  describe('ChatUtils', () => {
    ...
    describe('groupMessagesByDate', () => {
      ...
      it('should group messages by date correctly', () => {
        const messages = [
        { timestamp: new Date('2023-10-01T10:00:00Z'), content: 'Message 1' },
        { timestamp: new Date('2023-10-01T12:00:00Z'), content: 'Message 2' },
        { timestamp: new Date('2023-10-02T09:00:00Z'), content: 'Message 3' },
        ];
      ...
      it('should handle messages with the same timestamp', () => {
        const messages = [
        { timestamp: new Date('2023-10-01T10:00:00Z'), content: 'Message 1' },
        { timestamp: new Date('2023-10-01T10:00:00Z'), content: 'Message 2' },
        ];
        const result = chatUtils.groupMessagesByDate(messages);
      ...
      it('should handle messages with different time zones', () => {
        const messages = [
        { timestamp: new Date('2023-10-01T23:00:00Z'), content: 'Message 1' },
        { timestamp: new Date('2023-10-02T01:00:00+02:00'), content: 'Message 2' },
        ];
        const result = chatUtils.groupMessagesByDate(messages);
        expect(result.size).toBe(2);
        expect(result.get('Sun Oct 01 2023')).toEqual([
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      ...
      it('should handle input with undefined group values', () => {
        const input = [
      ...
      it('should handle input with null group values', () => {
        const input = [
        { id: 1, group: null },
        { id: 2, group: 'B' },
        { id: 3, group: null },
