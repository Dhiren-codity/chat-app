...
describe('ChatUtils', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('method to test', () => {
      it('should return "1 minute ago" for diffMins = 1', () => {
        const result = chatUtils.methodToTest(1);
        expect(result).toBe('1 minute ago');
      });
  
      it('should return "2 minutes ago" for diffMins = 2', () => {
        const result = chatUtils.methodToTest(2);
        expect(result).toBe('2 minutes ago');
      });
  
      it('should return "0 minutes ago" for diffMins = 0', () => {
        const result = chatUtils.methodToTest(0);
        expect(result).toBe('0 minutes ago');
      });
  
      it('should return "59 minutes ago" for diffMins = 59', () => {
        const result = chatUtils.methodToTest(59);
        expect(result).toBe('59 minutes ago');
      });
  
      it('should return "60 minutes ago" for diffMins = 60', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      ...
      it('should handle input with duplicate entries', () => {
        const input = [
        { id: 1, group: 'A' },
        { id: 1, group: 'A' },
        { id: 2, group: 'B' },
  ...
  describe('ChatUtils', () => {
    ...
    describe('getOtherParticipants', () => {
      ...
      it('should handle case where userId appears multiple times', () => {
