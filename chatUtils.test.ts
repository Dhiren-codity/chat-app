...
describe('ChatUtils', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      it('should return "1 day ago" when diffDays is 1', () => {
        const diffDays = 1;
        const result = chatUtils.methodToTest(diffDays);
        expect(result).toBe('1 day ago');
      });
  
      it('should return "2 days ago" when diffDays is 2', () => {
        const diffDays = 2;
        const result = chatUtils.methodToTest(diffDays);
        expect(result).toBe('2 days ago');
      });
  
      it('should return "0 days ago" when diffDays is 0', () => {
        const diffDays = 0;
        const result = chatUtils.methodToTest(diffDays);
        expect(result).toBe('0 days ago');
      });
  
      it('should return "100 days ago" when diffDays is 100', () => {
        const diffDays = 100;
        const result = chatUtils.methodToTest(diffDays);
        expect(result).toBe('100 days ago');
      });
  
      it('should return "-1 days ago" when diffDays is -1', () => {
        const diffDays = -1;
        const result = chatUtils.methodToTest(diffDays);
  ...
  describe('ChatUtils', () => {
    ...
    describe('methodToTest', () => {
      ...
      it('should handle input with null or undefined group values', () => {
        const input = [
        { id: 1, group: null },
