...
describe('ChatUtils', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('getUserDisplayName', () => {
      ...
      it('should return "Unknown User" if displayName and username are empty strings', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('formatHoursAgo', () => {
      ...
      it('should return "100 hours ago" for 100 hours difference', () => {
        const diffHours = 100;
        const result = chatUtils.formatHoursAgo(diffHours);
  ...
  describe('ChatUtils', () => {
    ...
    describe('isValidMessageContent', () => {
      it('should return false if content is null', () => {
      ...
      it('should return false if content is an empty string', () => {
        expect(chatUtils.isValidMessageContent('', maxLength)).toBe(false);
      });
  
      it('should return false if content is a string with only spaces', () => {
        expect(chatUtils.isValidMessageContent('   ', maxLength)).toBe(false);
      });
  
      it('should return false if content length exceeds maxLength', () => {
