...
describe('ChatUtils', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('getUserDisplayName', () => {
      ...
      it('should return "Unknown User" if displayName is an empty string and username is undefined', () => {
        const user = { displayName: '' };
        const result = chatUtils.getUserDisplayName(user);
        expect(result).toBe('Unknown User');
      });
  
      it('should return "Unknown User" if both displayName and username are empty strings', () => {
  ...
  describe('ChatUtils', () => {
    ...
    describe('getUnreadCount', () => {
      ...
      it('should return 0 if all messages are read for the user', () => {
        const messages = [
        { recipientId: 'user1', read: true },
        { recipientId: 'user1', read: true }
        ];
  ...
  describe('ChatUtils', () => {
    ...
    describe('formatRoomName', () => {
      ...
      it('should return "Group Chat (n members)" if room name is empty', () => {
        const room = { name: '   ', participants: ['user1', 'user2', 'user3'] };
        const result = chatUtils.formatRoomName(room, 'user1', []);
        expect(result).toBe('Group Chat (3 members)');
      });
