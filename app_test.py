...
class TestStartTyping:
    ...
    def test_start_typing_missing_fields(self, mock_typing_indicator, client, json_data, expected_status):
        ...
        mock_typing_indicator.user_started_typing.assert_called_once_with(
            json_data.get('room_id'), json_data.get('user_id'), json_data.get('username')
        )
