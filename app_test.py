...
def test_create_group_success(mock_group_manager, client):
    # Setup mock
    mock_group_manager.create_group.return_value = {'id': 1, 'name': 'Test Group', 'creator_id': 1, 'member_ids': [2, 3]}
    # Make request
...
def test_create_group_empty_member_ids(mock_group_manager, client):
    # Setup mock
    mock_group_manager.create_group.return_value = {'id': 1, 'name': 'Test Group', 'creator_id': 1, 'member_ids': []}
...
def test_customize_group_title_invalid_user_id(mock_group_manager, client):
...
def test_customize_group_title_internal_error(mock_group_manager, client):
    # Setup mock to simulate internal error
    mock_group_manager.customize_room_title.side_effect = Exception("Internal Error")
    # Make request
    response = client.post('/api/groups/1/customize', json={'custom_title': 'New Title', 'user_id': 1})
    # Assert
