...
class TestUpdateStatus:
    ...
    def test_update_status_missing_user_id(self, mock_status_manager, client):
        ...
        # Assert the response
        assert response.status_code == 400  # Assuming the route returns 400 for bad request
...
class TestStartTyping:
    ...
    def test_start_typing_missing_fields(self, payload, expected_status, client):
