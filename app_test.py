...
class TestStartTyping:
    ...
    def test_start_typing_missing_fields(self, json_data, expected_status, client):
...
class TestStopTyping:
    ...
    def test_stop_typing_invalid_input(self, mock_typing_indicator, client, payload):
        ...
        assert response.status_code == 200
        assert response.get_json() == {'success': True}
        mock_typing_indicator.user_stopped_typing.assert_called_once_with(payload['room_id'], payload['user_id'])
...
class TestRenameGroup:
    ...
    def test_rename_group_various_inputs(self, mock_update_group_name, client, group_id, new_name, user_id, expected_status, expected_response):
...
class TestUploadProfilePicture:
    ...
    def test_edge_cases(self, mock_upload, client, user_id, image_data, filename, expected_status, expected_response):
