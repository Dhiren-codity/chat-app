...
class TestStartTyping:
    ...
    @pytest.mark.parametrize("json_data", [
        {},  # Missing all fields
        {'room_id': '123'},  # Missing user_id and username
        {'user_id': '456'},  # Missing room_id and username
        {'username': 'testuser'},  # Missing room_id and user_id
    ])

    def test_start_typing_missing_fields(self, client, json_data):
