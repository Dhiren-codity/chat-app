...
class TestUploadProfilePicture:
    ...
    def test_upload_profile_picture_various_inputs(self, mock_upload, client, user_id, image_data, filename, expected_status, expected_response):
        mock_upload.return_value = expected_response if expected_status == 200 else None
...
class TestUpdateDisplayName:
    ...
    def test_update_display_name_edge_cases(self, mock_profile_manager, client, user_id, display_name, expected_status):
