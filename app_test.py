...
class TestUpdateStatusMessage:
    ...
    @pytest.mark.parametrize("status_message, expected_status_code, expected_response", [
        ('', 400, {'error': 'Update failed'}),
        (None, 400, {'error': 'Update failed'}),
    ...
    def test_edge_cases(self, mock_update_status_message, client, status_message, expected_status_code, expected_response):
        mock_update_status_message.return_value = None
