...
class TestLogin:
    ...
    def test_login_user_not_found(self, mock_user, client):
        ...
        # Make request
        response = client.post('/api/users/login', json={'username': 'nonexistentuser', 'password': 'any'})
...
def test_update_status_success(mock_status_manager, client):
    ...
    # Make a POST request to the update_status endpoint
...
def test_stop_typing_no_json(mock_typing_indicator, client):
    # Make a POST request without JSON data
