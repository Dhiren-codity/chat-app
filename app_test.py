...
class TestMarkMessageRead:
    ...
    @pytest.mark.parametrize("message_id, user_id, expected_status_code, expected_response", [
        (1, 1, 200, {'status': 'read'}),
    ...
    def test_mark_message_read_various_cases(self, mock_message_status_manager, client, message_id, user_id, expected_status_code, expected_response):
