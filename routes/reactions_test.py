...
class TestAddReaction:
    ...
    def test_add_reaction_various_inputs(self, mock_reaction_manager, client, user_id, message_id, emoji, expected_status, expected_response):
        if expected_status == 200:
            mock_reaction_manager.add_reaction.return_value = {'success': True}
        response = client.post('/api/reactions/add', headers={'X-User-ID': user_id}, json={
