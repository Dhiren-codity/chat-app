...
class TestGetMostPopular:
    ...
    def test_get_most_popular_none_emoji(self, mock_reaction_manager):
        """Test when no popular emoji is found (returns None)."""
        # Arrange
        ...
        assert response_data["success"] is True
        assert response_data["message_id"] == message_id
        assert response_data["most_popular_emoji"] is None
...
class TestBulkAddReactions:
    ...
    def test_bulk_add_reactions_missing_reactions_array(self, mock_request):
        """Test error when reactions array is missing"""
    ...
    def test_bulk_add_reactions_invalid_request_data(self, mock_request, request_data):
