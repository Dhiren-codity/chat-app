...
class TestGetMostPopular:
    ...
    @pytest.mark.parametrize("message_id,expected_status", [
        (1, 200),
        (999, 500),  # Assuming 999 is an invalid message_id
    ])
    @patch('routes.reactions.reaction_manager')
...
class TestGetAllowedEmojis:
    ...
    def test_get_allowed_emojis_success(self, mock_get_allowed_emojis, client):
        # Mock the return value of ReactionManager.get_allowed_emojis
        mock_get_allowed_emojis.return_value = ['👍', '❤️', '😂']

        # Make a GET request to the /api/reactions/allowed-emojis endpoint
    ...
    def test_get_allowed_emojis_empty(self, mock_get_allowed_emojis, client):
        # Mock the return value of ReactionManager.get_allowed_emojis to be empty
    ...
    def test_get_allowed_emojis_error(self, mock_get_allowed_emojis, client):
        # Mock the ReactionManager.get_allowed_emojis to raise an exception
