...
class TestDecoratedFunction:
    ...
    def test_happy_path_with_header(self, client, mocker):
        mocker.patch('routes.reactions.f', return_value=jsonify({"success": True}))
    ...
    def test_happy_path_with_query_param(self, client, mocker):
        mocker.patch('routes.reactions.f', return_value=jsonify({"success": True}))
