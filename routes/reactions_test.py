...
class TestAddReaction:
    ...
    @patch('routes.reactions.reaction_manager')
    def test_add_reaction_invalid_data(self, mock_reaction_manager, client):
...
class TestGetMessageReactions:
    ...
    @pytest.mark.parametrize("message_id, expected_status", [
        (1, 200),
        (999, 200),  # Assuming 999 is a valid message ID with no reactions
    ])
    @patch('routes.reactions.reaction_manager')
...
class TestGetReactionCount:
    ...
    @pytest.mark.parametrize("message_id, expected_status", [
        (1, 200),
        (999, 200),
        (0, 500),  # Assuming 0 might cause an error
    ])
    @patch('routes.reactions.reaction_manager')
