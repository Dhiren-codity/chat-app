...
class TestAddReaction:
    ...
    def test_add_reaction_internal_error(self, mock_reaction_manager, client):
...
class TestDecoratedFunction:
    ...
    @pytest.mark.parametrize("header_value,query_value,expected_user_id", [
        ('123', None, 123),
        (None, '456', 456),
        ('789', '101', 789),  # Header takes precedence
    ])

    def test_user_id_extraction(self, client, header_value, query_value, expected_user_id):
