...
class TestToggleReaction:
    ...
    def test_toggle_reaction_various_inputs(self, mock_reaction_manager, client, message_id, emoji, expected_status):
        mock_reaction_manager.toggle_reaction.return_value = {'success': True}
        response = client.post('/api/reactions/toggle', headers={'X-User-ID': '123'}, json={'message_id': message_id, 'emoji': emoji})
