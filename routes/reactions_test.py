...
class TestGetMostPopular:
    ...
    @pytest.mark.parametrize("message_id,emoji_result", [
        ("msg_1", "❤️"),
        ("msg_2", "😂"),
        ("msg_3", None),
        ("", "🎉"),
    ...
    def test_get_most_popular_various_inputs(self, mock_reaction_manager, message_id, emoji_result):
        # Arrange
        mock_reaction_manager.get_most_popular_emoji.return_value = emoji_result
        ...
        assert response_data["success"] is True
        assert response_data["message_id"] == message_id
        assert response_data["most_popular_emoji"] == emoji_result
