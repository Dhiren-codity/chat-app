...
class TestRequireAuth:
    ...
    def test_require_auth_various_inputs(self, client, headers, args, expected_status, expected_response):
    ...
    def test_require_auth_no_user_id(self, client):
        ...
        def test_route_no_user(user_id):
            return jsonify({"success": True})

        response = client.get('/test_no_user')
