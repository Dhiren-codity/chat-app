...
class TestAddReaction:
    ...
    def test_add_reaction_various_inputs(self, mock_reaction_manager, client, json_data, expected_status, expected_response):
        mock_reaction_manager.add_reaction.return_value = {'success': True}
        
        response = client.post('/api/reactions/add', headers={'X-User-ID': '123'}, json=json_data)
...
class TestDecoratedFunction:
    @pytest.mark.parametrize("headers, query_string, expected_status, expected_response", [
        ...
        ({}, {"user_id": "123"}, 200, None),    # Happy path with query string
